...
public class KnowPrimitiveDataTypes {
	...
	public static void main(String[] args) {
		...
		long box4=100000000l; // credit cards, transaction ids
		...
		System.out.println(variable2); //printing value of the variables
		System.out.println("variable2"); //printing text variables
